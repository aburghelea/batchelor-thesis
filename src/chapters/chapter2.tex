...
From \labelindexref{Equiation}{eqn:intensity-profile-pixel} and 
\labelindexref{Equiation}{eqn:distance-block} the distance between blocks A and B
...
a module of collision avoidance based on the \abbrev{ORCA}{Optical Recognition Collision Avoidance}

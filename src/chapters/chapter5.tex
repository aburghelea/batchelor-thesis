...
this module can offer full control for outside sources. The communication module
requires an XML file that defines the message format. In the XML file we can find
the \textbf{input} and \textbf{output} formats. The \textit{output} format is 

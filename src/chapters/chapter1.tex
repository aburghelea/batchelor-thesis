...
The necessity for advancements in \abbrev{UAV}{Unmanned Aerial Vehicle} domain
...
An \abbrev{UAS}{Unmanned Aerial System} or drone is a vehicle that doesn't have
a human pilot on board and can be either controlled by a \abbrev{RC}{Remote Control}, 
...
The current evolution of autopilots is in close relation with the development
...
\abbrev{TNI}{Teamnet International} company and \abbrev{ACS}{Faculty of Automatic
